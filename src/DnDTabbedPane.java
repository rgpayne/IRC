/*
 Most of this class taken straight from http://java-swing-tips.blogspot.com/2008/04/drag-and-drop-tabs-in-jtabbedpane.html
 */
                                ...
                                for (int i = 0; i < getTabCount(); i++) {
                                    ...
                                    if (otherChannel.name.equals(channel.server)) {
                                        try {
                                            ...
                                            otherChannel.insertString(msg, GUI.serverStyle, false);
                                            continue;
